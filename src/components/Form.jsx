    ...
    return (
        ...
        <form onSubmit={handleSubmit} >
            ...
            <div className='mb-3 mt-3'>
                <label className='text-lg'>
                    Descripción:
                    <textarea type="text" className='ml-2 rounded-md pl-2 w-1/3 h-8   align-middle bg-gray-500 text-white border-2 border-black' value={descripcion} onChange={(e) => setDescripcion(e.target.value)} />
                </label>
                <label className='ml-10 text-lg'>
                    Cantidad:
