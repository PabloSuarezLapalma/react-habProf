...
export default async function registrarIngreso(codigoBWS,nroRemito,estado,nombreResponsable,transporte,chasis,chofer,acoplado,costo,idMercaderia,fecha,hora,codigoCliente,destino,tipoUnidad,tipoTransporte, idPosicion, letraPosicion, sector, altura, volumen, idAlquiler, descripcion, largo, ancho, cantidad
    ){
